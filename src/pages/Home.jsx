...
import { Navigate, NavLink, useAsyncError, useNavigate } from "react-router-dom";
...
const isMobile = useMediaQuery(theme.breakpoints.down("sm"));
  ...
  useEffect(()=>{
        setPage(1);
  },[sortOrder, maxValue, searchText, selectWeight, selectBrand, selectCategory, selectFlavour])
 ...
 background: "linear-gradient(90deg, #007bff, #00c6ff)",
  ...
  >
    Clear All Filters
            ...
            ? (
             productReviews.reduce((a, b) => a + b.cust_rating, 0) /
...
>
      ...
      padding: "7px 7px 7px 7px"
                        ...
                        <div className="card-body flex-grow-1 d-flex flex-column">
                          <div style={{ display: "inline" }}>
                            <small style={{
                              ...
                              textOverflow: "ellipsis",
                                ...
                                <strong>{p.brand.toUpperCase()}</strong> - {p.name}
                            </small>
                          </div>
                          <div style={{ display: "inline" }}>
                              <small>{p.variant[0].flavour}</small> |{" "}
                              <small>{p.variant[0].weight > 999 ? `${p.variant[0].weight/1000}Kg` : `${p.variant[0].weight}g`}</small>
                          </div>
                          <div className="mt-3">
                            <h5
                              style={{ display: "inline", marginRight: "5%" }}
                            >
                              ₹{p.variant[0].price.toLocaleString("en-IN")}.00
                            </h5>
                            <del
                              style={{
                                fontSize: "15px",
                            ...
                            <b>
                              <small
                                style={{ display: "inline", color: "#34A56F" }}
                              >
                                ( {Math.round(
                          ...
                          {carts.some(c => c.product_id === p._id && c.variant_id === p.variant[0]._id) ? (
                            <Button
                              variant="outlined"
