                            ...
                            <div className="card-body">
                                ...
                                <div className="row d-flex align-items-center g-3">
                                    ...
                                    <div className="col-md-11">
                                        ...
                                        <div style={{ color: "grey" }}><small>{i.variant.qty ? `${i.variant.qty} Capsules` : i.variant.weight > 999 ? `${i.variant.weight/1000}Kg` : `${i.variant.weight}g`}{i.variant.flavour && `, ${i.variant.flavour}`}</small></div>
                                    </div>    
                                </div>
                                </div>
                                </div>
